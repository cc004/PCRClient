...
fp_common = open('Common.cs', 'w')
fp_req = open('Requests.cs', 'w')
fp_resp = open('Responses.cs', 'w')
fp_enum = open('Enums.cs', 'w')

fp_common.write('namespace PCRClient.Models;\n// ReSharper disable InconsistentNaming\n#pragma warning disable CS8618\n\n')
fp_req.write('namespace PCRClient.Models;\n// ReSharper disable InconsistentNaming\n#pragma warning disable CS8618\n\n')
fp_resp.write('namespace PCRClient.Models;\n// ReSharper disable InconsistentNaming\n#pragma warning disable CS8618\n\n')
fp_enum.write('namespace PCRClient.Models;\n// ReSharper disable InconsistentNaming\n#pragma warning disable CS8618\n\n')
...
for file in os.listdir('.'):
    ...
    if f'ReceiveParam' in classname:
        ...
        fp = fp_common
        fp.write(f'public class {classname}\n')
    fp.write('{\n')
    for match in member.finditer(text):
        ...
        if name == 'new' or name == 'break': name = '@' + name
    ...
    if f'PostParam' in classname:
        if classname[:-9] in urls2:
            fp.write(f'    internal override string Url => "{urls[urls2[classname[:-9]]]}";\n')
        else:
            header_used = []
...
for classname in set(refered_enum):
    ...
    with open(f'{classname}.cs', 'r', encoding='utf8') as f:
        text = f.read()
    fp.write(f'public enum {classname}\n')
    fp.write('{\n')
